# Using Claude Code: HTML 作为 Agent 输出格式的合理性
...
本文是 Anthropic 员工 Thariq 分享的关于 Claude Code 使用 HTML 作为输出格式的深度思考。作者认为，随着 AI Agent 能力的不断提升，Markdown 已经成为限制性格式，而 HTML 能够提供更丰富的信息表达。

**核心观点**：
- Markdown 在代码级别的文档中表现良好，但对于复杂的可视化需求显得力不从心
- HTML 可以表达几乎任何信息类型，包括表格、CSS 设计、SVG 图解、交互元素等
- 当用户不再直接编辑这些文件时，Markdown 的可编辑性优势被削弱
...
[![Image 1: Image](https://pbs.twimg.com/media/HHz_q48aAAAaCfW?format=jpg&name=small)](https://x.com/trq212/article/2052809885763747935/media/2052796642479439872)
...
[![Image 2: Image](https://pbs.twimg.com/media/HH0CDc6a8AAy1bv?format=png&name=small)](https://x.com/trq212/article/2052809885763747935/media/2052799263474905088)

Claude Code trying to show color in markdown

[![Image 3: Image](https://pbs.twimg.com/media/HH0AgqJbcAAaEcZ?format=jpg&name=small)](https://x.com/trq212/article/2052809885763747935/media/2052797566220464128)
...
[![Image 4: Image](https://pbs.twimg.com/media/HH0Ao0tbYAAOF9e?format=jpg&name=small)](https://x.com/trq212/article/2052809885763747935/media/2052797706494763008)

HTML can allow you to interact with the document, for example you might want to ask it to add sliders or knobs to adjust a design or allow you to tweak different options in the algorithm to see what happens. You can also ask it to let you copy these changes into a prompt to paste back into Claude Code. Read more about my playgrounds post to see examples of this two way interaction:
...
To make this more concrete, I’ve made many different HTML files for different use cases. You can view all of them here:
...
[![Image 5: Image](https://pbs.twimg.com/media/HH0BFWLbMAEk_7T?format=jpg&name=small)](https://x.com/trq212/article/2052809885763747935/media/2052798196515287041)
...
[![Image 6: Image](https://pbs.twimg.com/media/HH0BRSQbMAAuuof?format=png&name=small)](https://x.com/trq212/article/2052809885763747935/media/2052798401620946944)
...
[![Image 7: Image](https://pbs.twimg.com/media/HH0BXqjboAAHGsw?format=jpg&name=small)](https://x.com/trq212/article/2052809885763747935/media/2052798511222333440)
...
[![Image 8: Image](https://pbs.twimg.com/media/HH0Bp86bUAAJDyZ?format=jpg&name=small)](https://x.com/trq212/article/2052809885763747935/media/2052798825388265472)
...
[![Image 9: Image](https://pbs.twimg.com/media/HH0FbKebUAAsRPr?format=jpg&name=small)](https://x.com/trq212/article/2052809885763747935/media/2052802969377394688)
...
| 表格数据 | 有限支持 | 完整表格功能 |
| 设计数据 | 无 | CSS 样式支持 |
| 图解表达 | ASCII 艺术 | SVG 支持 |
| 代码片段 | 基础代码块 | script 标签支持 |
| 交互元素 | 无 | JavaScript + CSS |
| 工作流图 | 限制 | SVG + HTML 流程图 |
| 空间数据 | 无 | absolute position / canvas |
| 图像 | 外部引用 | img 标签内嵌 |

### 2. 具体使用场景

作者在文章中分享了多个实际使用 HTML 的场景，包括：
- 复杂的技术文档和规格说明
- 需要丰富可视化的脘脖产出
- 需要分享和在浏览器中查看的内容
...
Thariq 作为 Claude Code 团队成员，观察到：
- 团队内部越来越多地使用 HTML 作为输出格式
- 当文档超过 100 行 Markdown 时，阅读体验显著下降
- AI 在 Markdown 中尝试使用 ASCII 艺术和 Unicode 字符表达颜色，但效果有限

---

## 实践建议

如果你也在使用 Claude Code 或类似的 AI Agent 工具，可以考虑：

1. **对于复杂项目**：尝试让 Agent 生成 HTML 格式的文档，而非 Markdown
2. **利用 CSS 样式**：让 AI 为文档添加品牌色彩和视觉层次
3. **使用 SVG**：对于流程图、架构图等，用 SVG 替代 ASCII 图解
4. **浏览器预览**：HTML 文档可以直接在浏览器中打开查看
